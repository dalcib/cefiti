...
export class Node {
    ...
    insertBefore(newNode: Node, referenceNode: Node | null) {
        ...
        if (referenceNode.previousSibling) referenceNode.previousSibling.nextSibling = newNode;
...
export class Element extends Node {
    ...
    get textContent(): string {
        return this.childNodes.map(c => (c instanceof Text ? c.data : (c as Element).textContent)).join("");
    }
    set textContent(v) {

...
- [ ] Task: Support class-based state containers with automatic signal conversion for getters/setters
- [ ] Task: Optimize array handling to avoid re-wrapping during iteration
